...
<title>Sign Up Form by openassu</title>
...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>">;
						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								<label for="firstname"><i
									...
									type="text" name="firstname" id="firstname" placeholder="Your firstname" required="required"/>
							</div>
							
							<div class="form-group">
								<label for="familyname"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="familyname" id="familyname" placeholder="Your Family Name" required="required" />		
							</div>
							<div class="form-group">
	...
	<link rel="stylsheet" href="alert/dist/sweetalert.css">
...
<script type ="text/javascript">
	...
	if(status == "invalidFristName"){
		swal("Error", "Please Enter Your Firstname", "error");
	}
	if(status == "invalidFamilyName"){
		swal("Error", "Please Enter Your Family Name", "error");
	}
