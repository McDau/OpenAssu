            ...
            <div class="nano-content">
                <ul>
                   ...
                   <li><a href="client-list.jsp"><i class="ti-user"></i> Client </a></li>
                    ...
                    <li><a href="#"><i class="ti-settings"></i> Param�tres </a></li>
            ...
            <div class="col-lg-12">
              <div class="card">
                 <div class="inbox-head">
                            <h3 <a href="<%=request.getContextPath()%>/list" class="nav-link">Clients</h3>
                            <form action="#" class="pull-right position">
                              <div class="input-append inner-append">
                                <input type="text" class="sr-input" placeholder="tapez l'ID du client">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-3">
                      <a href="<%=request.getContextPath()%>/new" class="btn btn-lg btn-success btn-block waves-effect waves-light">
                        <i class="fa fa-plus"></i> Nouveau client </a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td scope="row"><c:out value="${client.idClients}" /></td>
                                                    <td><c:out value="${client.nomClient}"/></td>
                                                    <td><c:out value="${client.prenomClient}" /></td>
                                                    <td><c:out value="${client.dateNaissanceClient}" /></td>
                                                    <td><c:out value="${client.sexeClient}" /></td>
                                                    <td><c:out value="${client.nomAssureurClient}" /></td>
                                                    <td><a href="edit?idClients=<c:out value='${client.idClients}' />">Modifier</a>
                                                    			&nbsp;&nbsp;&nbsp;&nbsp;
                                                    	<a href="delete?idClients=<c:out value='${client.idClients}' />">Supprimer</a></td>
                                                </tr>
                                              	</c:forEach>
